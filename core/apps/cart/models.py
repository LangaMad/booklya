...
class Cart(models.Model):
    book = models.ManyToManyField(Book, through='CartItem', related_name='book_cart')
...
class CartItem(models.Model):
    ...
    quantity = models.PositiveIntegerField('Колличиства', default=1)

    def __str__(self):
        return f'Книга {self.book.title} в корзина '